...
.center{background-color:white;margin-left:200px; overflow:scroll; overflow-x:hidden;margin-left:20%;width:60%;}
...
<div class="head" style="position: fixed; width: 100%;height:13%; background-color: white;margin-top: 1px;"><?php include('./mainheader.php');?></div>
<div class='bodywrap'>
        <div class='left'>
<ul >
